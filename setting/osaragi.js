...
contextInfo: {
    externalAdReply: {
        ...
        body: `🕑 ${waktu}`,
        sourceUrl: '',
        thumbnail: await fs.readFileSync('./media/jadwal.png'),
...
'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ttname,;;;\nFN:ttname\nitem1.TEL;waid=6285771756455:+62 858-8322-5704\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
sendEphemeral: true
}}
}
const qpayment = {
...
╰──────────────━`
osaragi.sendMessage(m.chat, {
       image: { url: 'https://files.catbox.moe//o4zbyj.png'},
       caption: awal,
    contextInfo: {
...
externalAdReply: {
showAdAttribution: true, 
thumbnail: await fs.readFileSync("./media/Menu.png"), 
...
osaragi.CAI = osaragi.CAI ? osaragi.CAI : {};
    ...
    if (text === "on") {
        ...
        m.reply(`[ ✓ ] ᴀᴜᴛᴏ ᴀɪ ʙᴏᴛ *\`Ofc.SyadBotz\`* : ᴀᴋᴛɪғ [ √ ]`);
    } else if (text === "off") {
        delete osaragi.CAI[sender];
        m.reply(`[ ✓ ] ᴀᴜᴛᴏ ᴀɪ *\`Ofc.SyadBotz\`* : ɴᴏɴᴀᴋᴛɪғ [ √ ]`);
    }
};
break
